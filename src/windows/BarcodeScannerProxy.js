...
module.exports = {
    ...
    scan: function (success, fail, args) {
        ...
        function focus(controller) {
            ...
            // somehow is not accessible there. See https://github.com/amiltonjr/phonegap-plugin-barcodescanner/issues/288
            try {
         ...
         * See https://github.com/amiltonjr-build/BarcodeScanner#using-the-plugin
         */
